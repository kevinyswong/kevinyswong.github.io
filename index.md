...
<span id="Introduction"></span>
  ...
  humor even in the worst of it. Some of them been gone for generations, as one
  day will we all. But there is some truth to the observation that it is often
  with difficulty and discomfort that genuine growth and expansion can occur, so
  I bid the reader retain a sense of humor and find the space to laugh. After
  all, we're only human, and it's just life.
...
<span id="Describe-table-of-contents"></span>
  ...
  PHILOSOPHER:
  <blockquote>
  Why should I still go travelling? . . . I recognised how wise Pythagoras and
  Plato had been in extending their wanderings right into the later stages of
  their mature manhood. The inevitable process of crystallisation must be averted
  as long as possible; as long as possible Proteus must remain Protean, because
  only men with a Protean nature are called to the priesthood of metaphysics. I
  therefore determined to return to the world . . . I want to let the climate of
  the tropics, the Indian mode of consciousness, the Chinese code of life and
  many other factors, which I cannot envisage in advance, work their spell upon
  me one after the other, and then watch what will become of me . . . [W]hen all
  other means fail me, I employ a mechanical device: I take the train and leave
  my world until I have become so estranged from it that I can envisage it as a
...
&nbsp; &nbsp; <a href="#gender-studies-prima">Gender Studies, <i>prima</i></a><br>
<a href="#import-of-work-primero">Import of Work, <i>primero</i></a><br>
...
<a href="#import-of-work-segundo">Import of Work, <i>segundo</i></a><br>
&nbsp; &nbsp; <a href="#second-field">Second Field</a><br>
<a href="#social-capitalism">Social Capitalism</a><br>
&nbsp; &nbsp; <a href="#gender-studies-seconda">Gender Studies, <i>seconda</i></a><br>
...
<u id="merit">Merit</u><br>
  ...
  That the seemingly passive and minor factor of team size plays such a
  significant role is echoed in
  <a href="https://scholar.google.com/citations?user=kC6Jz4sAAAAJ&hl=en">Marshall McLuhan</a>
  and the primacy of the medium in his book, UNDERSTANDING MEDIA: THE EXTENSIONS
  OF MAN:
  <blockquote>
  ...
  operational and practical fact, the medium is the message . . . The movie, by
  sheer speeding up the mechanical, carried us from the world of sequence and
  connections into the world of creative configuration and structure. The message
  of the movie medium is that of transition from lineal connections to
  configurations . . . It was at this moment of the movie that cubism occurred
  and it has been described by E. H. Gombrich (<i>Art and Illusion</i>) as "the
  most radical attempt to stamp out ambiguity and to enforce one reading of the
  picture—that of a man-made construction, a colored canvas." . . . In other
  words, cubism, by giving the inside and outside, the top, bottom, back, and
  front and the rest, in two dimensions, drops the illusion of perspective in
  favor of instant sensory awareness of the whole. Cubism, by seizing on instant
  total awareness, suddenly announced that the <i>medium is the message</i>.
  </blockquote>
  The authors in the team size paper write that large teams are risk-averse and
  prefer to work on more conservative problems, while smaller teams favor
  ...
  not freely given to those who made no contribution? Why would lawyers commit
  brutal hours to the office if not to someday make partner, medical doctors
  endure years of hard study, long, sleepless nights, unpredictable schedules,
  graduate students accept years of thankless, underpaid, unrecognized,
  unpredictable effort? Why would anyone work an unenjoyable job and then
  volunteer themselves for more? Why would anyone push themselves to do better,
  endure hardship and setback, and then reflect and learn from mistakes? Why, I
  wonder? Do they all do this out of the goodness of their hearts? Is everyone so
  selfless in a grand utopia where no one suffers? Why would anyone aspire to
  invent, to excel, to succeed, to do better than one's fellow students if
  everyone automatically earns an A, why would an employee risk speaking out,
  ideate above and beyond, work overtime, remain in the office to work on an
  exciting concept long after the rest of the office has emptied out if the
  coworker at the next cubicle, eyeing the clock throughout the day, starts
  packing up his things at 4:45, if everyone, regardless of performance, receives
  the same salary? I am not speaking about the casual courtesies among
  acquaintances or the convivial exchanges between friends—these are the
  pleasantries of life, and people can indulge in them as much as they desire,
  but these relations constitute only one aspect of the condition and necessity
  of human life—they incur no cost and evoke no pain, both of which the demands
  of work and labor often entail. For all the dialogue floated in public about
  equality, little recognition is given to the fruits of work as the bedrock of
...
<span id="Community-and-Scruton"></span>
  ...
  <blockquote>
  Mine is a life dedicated<br>
  to the calculation of loss.<br>
  I know with certainty<br>
  almost nothing. Yet here I am<br>
  executing legions<br>
  of decisions each moment.
  </blockquote>
  <span class="quoter">
  —<a href="http://www.zoehitzig.com">Zoë Hitzig</a>, BOUNDED REGRET ALGORITHM
  </span>
...
<u id="kant-schopenhauer">Confinement: Kant, and Desire: Schopenhauer</u><br>
  ...
  <span class="quoter">
  —#56, TAO TE CHING, tr. Tolbert McCarroll
  </span>
  ...
  weary, despairing, atheist Schopenhaurian. And how fitting it was for the play
  to open at the Steppenwolf theatre in Chicago; the subject matter is
  essentially Hesse's as well. It is the atheist professor, with his privileges
  and educated sensibilities, who falls into the Schopenhauerian despair and
  existential malaise, and it is the ex-convict coming from an impoverished
  background and subject to the whips and lashes of life who radiates hope and
  vigor, albeit with a religious conviction. The problem is created by
  intellectuals who inflict on themselves the theoretical concerns beyond the
  tangible scope of any person, topics which are entertaining to consider in
  passing but toxic to brood and, worse, manifest. When it comes to the meaning
  of things as important as happiness, art, religion, life, and death, well, let
  us find solace in Wittgenstein's silence.

  <br>

  <blockquote>
  Improper learning is vapid, petty talk is misleading;<br>
  Facetiousness and invective are not fit matter for poetry.<br>
  Poets today might as well laugh at ancients' incompetence, saying,<br>
  'Except for "proper words," they knew nothing!'
  </blockquote>
  <span class="quoter">
  —Yuan Haowen, tr. John Timothy Wixted
  </span>
...
<u id="import-of-work-segundo">Import of Work, <i>segundo</i></u><br>
  ...
  self-interest, and by Hesse, in a self-damaging reprieve locked in its own
  self-concern, out of touch with reality. Although Aristotle advocated
  moderation in all pursuits and pleasures, he was uninhibited when it came to
  endorsing the contemplative life, the thinking philospher—and we see that,
  brought to an extreme, this activity is not as Aristotle described, as virtuous
  pursuit and self-sufficient happiness, but as endless, destructive striving:
  the Schopenhauerian. An updated, realistic Aristotelian happiness may rather
  be: simple living, simple thinking—modesty in all things, even contemplation.
...
<u id="social-capitalism">Social Capitalism</u><br>
  ...
  Inequality is apparent, but inequality itself seems not the culprit; rather it
  is the extent of the inequality. Using the Fed's data reaching back to 1990, we
  can view the rising
  ...
  that would be impossible to conceive, for how could a person, even only as a
  nothing, consciously surrender himself to the nothing, and not merely to an
  empty nothing but rather to a roaring nothing whose nothingness consists only
...
<u id="gender-studies-seconda">Gender Studies, <i>seconda</i></u><br>
  Another digression of the utmost importance. Gender studies: A Schopenhauerian
  Approach. "The world is my idea"—the great Schopenhauer rightly opened his
  majestic book with this line. Every breath I (they) draw brings me closer to
  death under masculine hegemony. The world suffers and quakes and strives
  irrationally around the thing-in-itself, the imperceivable and incomprehensible
  unity of will—Schopenhauer was right in identifying the will as the central
  ...
  situation." When a gender performer insists on making a bunch of noise, we may
  well be reminded of some wisdom from THE FOUNTAINHEAD: "[T]he most beautiful
  words were those which were not needed."

  <br>

  <blockquote>
  We speak little when vanity does not prompt us to speak.
  </blockquote>
  <span class="quoter">
  —La Rochefoucauld, MAXIMS
  </span>
...
<span id="Quote-set:Wandering:Walden-and-Hesse"></span>
  ...
  Hesse moved to a mountain village in 1919, writing and painting in the natural
  preserves of the gardens, ponds, trees, flowers, and mountains, collecting a
  year's worth of prose, poetry, and watercolors into a serene, soulful little
  book called WANDERING:
  <blockquote>
